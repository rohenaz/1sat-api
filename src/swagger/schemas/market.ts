...
export const MarketData: SwaggerSchema = {
	type: "object",
	properties: {
		tick: {
			type: "string",
...
export const SearchResult: SwaggerSchema = {
	type: "object",
	properties: {
		type: {
			type: "string",
		...
		id: {
			...
			example:
				"b00cfb76b0022a372c82f71031a8e93550ecba2b5582c44d1efaf2640b3c559e_0",
		},
		name: {
			type: "string",
...
export const SearchResponse: SwaggerSchema = {
	type: "object",
	properties: {
		query: {
			type: "string",
