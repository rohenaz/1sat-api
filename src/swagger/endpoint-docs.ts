...
export const endpointDocs = {
	...
	status: {
		detail: {
			...
			description:
				"Get API health status, blockchain info, indexer status, exchange rates, and aggregated market statistics with USD quotes",
			tags: ["Status"],
		},
	},
	...
	marketList: {
		detail: {
			...
			description:
				"Get paginated list of all tokens with market data, prices in BSV and USD, sorted by various criteria",
			tags: ["Market"],
		},
	},
	...
	marketById: {
		detail: {
			...
			description:
				"Get detailed market data for a specific token by ID or ticker symbol, including USD quotes",
			tags: ["Market"],
		},
	},
	...
	marketSearch: {
		detail: {
			...
			description:
				"Search for tokens in the market by ticker or symbol (legacy endpoint, use /search instead)",
			tags: ["Market"],
		},
	},
	...
	mint: {
		detail: {
			...
			description:
				"Get tokens that are still available for minting (supply < max)",
			tags: ["Market"],
		},
	},
	...
	search: {
		detail: {
			...
			description:
				"Search across all BSV20 and BSV21 tokens with relevance scoring, USD quotes, and type filtering",
			tags: ["Search"],
		},
	},
	...
	userBalance: {
		detail: {
			...
			description:
				"Get all BSV20 and BSV21 token balances for a specific address with USD valuations",
			tags: ["User"],
		},
	},
	...
	collectionMarket: {
		detail: {
			...
			description:
				"Get active listings for a collection with filtering by traits, price range, and sorting. Traits filter format: 'TraitName:Value,AnotherTrait:Value'",
			tags: ["Collections"],
		},
	},
	...
	collectionItems: {
		detail: {
			...
			description:
				"Get items/NFTs in a collection with filtering by traits and sorting. Traits filter format: 'TraitName:Value,AnotherTrait:Value'",
			tags: ["Collections"],
		},
	},
	...
	tickerAutofill: {
		detail: {
			...
			description:
				"Search for tickers by partial match for autofill/typeahead functionality",
			tags: ["Ticker"],
		},
	},
	...
	adminConsolidate: {
		detail: {
			...
			description:
				"Admin endpoint to consolidate UTXOs (requires authentication)",
			tags: ["Admin"],
		},
	},
